...
for image_path in TEST_IMAGE_PATHS:
    ...
    image_np_i = image_np.copy()
    # Actual detection.
    output_dict = run_inference_for_single_image(image_np, detection_graph)

    class_mask = np.logical_and(output_dict['detection_classes'] == 3, output_dict['detection_scores'] >= 0.35)
    output_dict['detection_boxes'] = output_dict['detection_boxes'][np.nonzero(class_mask)]
